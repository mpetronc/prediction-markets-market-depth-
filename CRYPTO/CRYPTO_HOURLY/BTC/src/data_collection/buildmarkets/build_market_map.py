"""Build the exact BTC hourly time-and-strike market registry."""
...
def main(run_log: RunLog) -> None:
    ...
    run_log.info(
        f"Matching configured family=hourly_fixed_strike asset=BTC "
    ...
    for expiration_text, strike in common_keys:
        ...
        pairs.append(
            {
                "pair_id": f"BTC_1H_{time_code}_S{strike_code}",
                "asset": "BTC",
