"""Build the exact ETH hourly time-and-strike market registry."""
...
OUT_PATH = ASSET_ROOT / "data/matched_markets/ETH_market_map.csv"
UNMATCHED_POLY_PATH = (
...
def main(run_log: RunLog) -> None:
    ...
    run_log.info(
        f"Matching configured family=hourly_fixed_strike asset=ETH "
    ...
    for expiration_text, strike in common_keys:
        ...
        pairs.append(
            {
                "pair_id": f"ETH_1H_{time_code}_S{strike_code}",
                "asset": "ETH",
