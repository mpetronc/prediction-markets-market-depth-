"""Offline checks for the SOL hourly fixed-strike collection pipeline."""
...
class PipelineLogicTests(unittest.TestCase):
    ...
    def test_native_kalshi_ticker_uses_eastern_expiration_hour(self) -> None:
        ...
        self.assertEqual(kalshi_event_ticker(expiration), "KXSOLD-26AUG1008")
        self.assertEqual(
            kalshi_market_ticker(expiration, "63800"),
            "KXSOLD-26AUG1008-T63799.9999",
        )

    def test_both_platform_titles_resolve_to_same_strike(self) -> None:
        self.assertEqual(
            parse_strike("Solana above $63,800 on August 10?"),
            Decimal("63800"),
        )
    ...
    def test_polymarket_resolution_source_is_asset_specific(self) -> None:
        market = {
            ...
            "title": "Solana above $100 on August 11?",
            "description": "Resolution uses the Binance SOL/USDT 1 hour candle.",
