"""Discover the matching Kalshi BTC 15-minute markets from Predexon."""
...
def expected_market_tickers() -> list[str]:
    ...
    while end <= WINDOW_END:
        ...
        result.append(f"KXBTC15M-{suffix}-{local_end.strftime('%M')}")
...
def main(run_log: RunLog) -> None:
    ...
    run_log.info(
        "Discovery configured venue=kalshi family=up_down_15m asset=BTC "
