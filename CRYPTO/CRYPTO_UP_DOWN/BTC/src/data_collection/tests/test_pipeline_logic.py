"""Offline checks for the BTC 15-minute collection pipeline."""
...
class PipelineLogicTests(unittest.TestCase):
    ...
    def test_expected_ticker_grid_covers_exact_two_week_window(self) -> None:
        ...
        self.assertEqual(tickers[0], "KXBTC15M-26AUG100715-15")
        self.assertEqual(tickers[-1], "KXBTC15M-26AUG240700-00")
