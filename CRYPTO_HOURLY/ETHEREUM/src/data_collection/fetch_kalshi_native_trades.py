"""Fetch exact ETH hourly fixed-strike Kalshi trades from Kalshi's public API.
...
MAP_PATH = ASSET_ROOT / "data/matched_markets/ETH_market_map.csv"
...
def build_summary(audits: list[dict[str, object]]) -> dict[str, object]:
    """Build concise totals for the hourly fractional-trade audit."""
