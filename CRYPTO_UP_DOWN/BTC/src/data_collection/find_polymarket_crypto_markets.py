"""Discover BTC 15-minute Up/Down markets from Predexon."""
...
def normalize_market(market: dict) -> tuple[dict | None, str]:
    ...
    reasons: list[str] = []
    if str(market.get("asset", "")).lower() != "btc":
        reasons.append("asset is not btc")
...
def main(run_log: RunLog) -> None:
    ...
    run_log.info(
        "Discovery configured venue=polymarket family=up_down_15m asset=BTC "
